...
import {
  Building2, Globe, CreditCard, Rocket, Check, ChevronRight,
  ArrowLeft, ArrowRight, Loader2, Wifi, Clock, DollarSign,
  Phone, Mail, MapPin, FileText, AlertCircle,
} from "lucide-react";
...
export default function SetupWizard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex" style={{ minHeight: 540 }}>
          ...
          <div className="flex-1 p-8 overflow-y-auto">
            ...
            {step === 0 && (
              <div className="max-w-lg">
                ...
                <p className="text-gray-500 text-base leading-relaxed mb-6">
                  Let's configure your ISP management system. This takes about
                  <strong className="text-gray-700"> 2 minutes</strong> and you can
                ...
                <div className="grid grid-cols-2 gap-3 mb-8">
                  {[
                    ...
                    { icon: Wifi,      label: "Ready to manage your ISP" },
                  ].map(({ icon: Icon, label }) => (
                ...
                {systemInfo && (
                  <div className="flex items-center gap-2 text-xs text-gray-400 mb-6">
                    ...
                    Server running · NetPulse v{systemInfo.version}
                  </div>
                )}
              </div>
            )}
            ...
            {step === 1 && (
              <div className="max-w-lg">
                ...
                <p className="text-gray-400 text-sm mb-6">This appears on invoices, reports, and customer communications.</p>
                ...
                <div className="space-y-4">
                  ...
                  <Field label="NTP Server" icon={Clock} hint="Routers sync time to this server">
                    <Input
                      ...
                      onChange={(e) => set("ntpServer", e.target.value)}
            ...
            {step === 3 && (
              <div className="max-w-lg">
                ...
                <p className="text-gray-400 text-sm mb-6">These apply to all invoices. You can override per-customer later.</p>
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <Field label="Payment Due (days)" hint="Days before invoice is overdue">
                      <Input
                        type="number"
                        min="1"
                    ...
                    <Field label="Auto-Suspend (days)" hint="Days after due date">
                      <Input
                        ...
                        onChange={(e) => set("autoSuspendDays", e.target.value)}
                        placeholder="3"
                      />
                    </Field>
                    <Field label="Grace Period (days)" hint="Before suspension kicks in">
                      <Input
                        type="number"
                        min="0"
            ...
            {isDone && (
              <div className="max-w-lg text-center py-4">
                ...
                <p className="text-gray-500 text-sm mb-8">
                  NetPulse is configured and ready to go.
                  Head to the dashboard to start managing your ISP.
                </p>
