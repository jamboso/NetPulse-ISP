...
import { ArrowLeft, Clock, User, AlertCircle, Send } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4 mb-2">
        ...
        <div className="flex gap-2">
          <Button variant="outline" className="bg-white">Close Ticket</Button>
        </div>
      </div>
            ...
            {loadingReplies ? (
              ...
              replies.map((reply) => (
                <div key={reply.id} className={`bg-white rounded-lg border shadow-sm overflow-hidden ${reply.isStaff ? 'border-blue-200 ml-8' : 'border-gray-200 mr-8'}`}>
                    ...
                    <div className="flex gap-3 items-center">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">
                          {reply.isStaff ? 'Staff Member' : 'Customer'}
                        </div>
                      </div>
                    </div>
                    <div className="text-xs text-gray-500">
                  ...
                  <div className="p-4 text-gray-800 whitespace-pre-wrap text-sm leading-relaxed">
                    {reply.message}
                  </div>
                </div>
              ))
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
            ...
            <form onSubmit={handleReplySubmit}>
              <Textarea 
                ...
                className="min-h-[120px] mb-3 resize-y focus-visible:ring-blue-500 border-gray-300"
              />
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-5">
            ...
            {ticket.customer ? (
              <div className="space-y-3">
                <Link href={`/customers/${ticket.customerId}`} className="font-medium text-blue-600 hover:underline block truncate">
