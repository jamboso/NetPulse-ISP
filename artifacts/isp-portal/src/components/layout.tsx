...
export default function Layout({ children }: LayoutProps) {
  ...
  const navItems = [
    ...
    { name: "Network",       href: "/network",      icon: ServerCrash,     show: canManageNetwork && !canManageCustomers },
    { name: "Network Map",   href: "/map",          icon: MapPin,          show: canManageNetwork && !canManageCustomers },
    { name: "Monitoring",    href: "/monitoring",   icon: MonitorDot,      show: canManageNetwork && !canManageCustomers },
